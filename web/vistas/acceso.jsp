...
<html>
  ...
  <%
    ...
    Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/ismaelgym","root", "");
    ...
    if (coincidencias.getInt(1) == 0) {
      ...
      mensaje = "<p>Tiene acceso al área de gestión de socios.</p>"; // candado abierto
      enlace = "../Controlador?accion=listar";
    } else {
